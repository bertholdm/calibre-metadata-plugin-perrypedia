...
[Metadata Source Plugin] Perrypedia - Version 1.1.0 - 01-19-2021
...
Einschränkungen:
------------
- Wenn das zurückgegebene Veröffentlichungsdatum nur das Jahr enthält, wird das Veröffentlichungsdatum auf den 1. Januar dieses Jahres festgelegt.
...
Limitations:
------------
- If the returned publication date contains only the year, the publish date is set to january, 1 of that year.
